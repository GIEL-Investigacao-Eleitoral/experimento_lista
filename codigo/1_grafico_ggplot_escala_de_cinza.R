...
ggsave("C:/Users/08451589707/Documents/GitHub/experimento_lista/anpocs/grafico1_cinza.png",
       width = 17,
       height = 17,
       units = "cm",dpi = 300)
...
ggplot(resultado, aes(x=categoria, y=m.diff, group=categoria,color=categoria,fill=categoria)) +
  ...
  geom_hline(yintercept = 0,linetype='dashed', col = 'red') +
  scale_colour_manual(values = c("#bfbfbf","#3f3f3f", "#3f3f3f","#3f3f3f","#bfbfbf", "#bfbfbf", "#3f3f3f","#3f3f3f","#3f3f3f","#bfbfbf", "#bfbfbf","#bfbfbf", "#bfbfbf")) +
  scale_fill_manual(values = c("#bfbfbf","#3f3f3f", "#3f3f3f","#3f3f3f","#bfbfbf", "#bfbfbf", "#3f3f3f","#3f3f3f","#3f3f3f","#bfbfbf", "#bfbfbf","#bfbfbf","#bfbfbf")) +
  coord_flip()+
  theme_classic()+
  theme(legend.position="none")+
  labs(y='diferença entre as médias',x='')

ggsave("C:/Users/08451589707/Documents/GitHub/experimento_lista/anpocs/grafico2_cinza.png",
       width = 17,
       height = 17,
       units = "cm",dpi = 300)
